...
data.write("\n");
data.write("1 "+str(0.7533)+" 180.00"+"\n");
data.write("2 "+str(0.5573)+" 180.00"+"\n");
data.write("3 "+str(0.3407)+" 180.00"+"\n");
data.write("4 "+str(0.3908)+" 180.00"+"\n");
data.write("5 "+str(0.2017)+" 180.00"+"\n");
data.write("6 "+str(0.0711)+" 180.00"+"\n");
data.write("\n");
data.write("Atoms\n");
data.write("\n");
...
for i in range(cell*cell*cell):
	index=changeindex(i,cell);
	data.write(str(i+cell*cell*cell*1+1)+" "+"1"+" "+"3"+" "+str(zr_valen)+" "+str(cell_length*index[0]+cell_length/2)+"  "+str(cell_length*index[1]+cell_length/2)+" "+str(cell_length*index[2]+cell_length/2)+"\n");
for i in range(cell*cell*cell):
	'''bottom to up'''
	index=changeindex(i,cell);
	data.write(str(i+2*cell*cell*cell+1)+" "+"1"+" "+"4"+" "+str(ox_valen)+" "+str(cell_length*index[0]+cell_length/2)+" "+str(cell_length*index[1]+cell_length/2)+" "+str(cell_length*index[2])+"\n");
for i in range(cell*cell*cell):
	'''front to back'''
	index=changeindex(i,cell);
	data.write(str(i+3*cell*cell*cell+1)+" "+"1"+" "+"4"+" "+str(ox_valen)+" "+str(cell_length*index[0]+cell_length/2)+" "+str(cell_length*index[1])+" "+str(cell_length*index[2]+cell_length/2)+"\n");
for i in range(cell*cell*cell):
	'''left to right'''
	index=changeindex(i,cell);
	data.write(str(i+4*cell*cell*cell+1)+" "+"1"+" "+"4"+" "+str(ox_valen)+" "+str(cell_length*index[0])+" "+str(cell_length*index[1]+cell_length/2)+" "+str(cell_length*index[2]+cell_length/2)+"\n");
data.write("\n");
data.write("Angles\n");
data.write("\n");
four=np.zeros(4);
